...
def main(config=None):
    ...
    search_query = scholarly.scholarly.search_pubs(
        '''allintitle: Data Cube: A Relational Aggregation Operator Generalizing Group-By, Cross-Tab, and Sub-Totals author:"J Gray" source:"Data Mining and Knowledge Discovery"'''
    )
