...
def snowball(config=None, outfile=None, infile=None):
    ...
    file_path_queued_ids = os.path.join(
        data_dir, conf.get("000_download", "file_path_queued_ids")
    )
    file_path_known_ids = os.path.join(
        data_dir, conf.get("000_download", "file_path_known_ids")
    )
    file_path_done_ids = os.path.join(
        data_dir, conf.get("000_download", "file_path_done_ids")
    )
    file_path_seed_ids = os.path.join(
        data_dir, conf.get("000_download", "file_path_seed_ids")
    )
