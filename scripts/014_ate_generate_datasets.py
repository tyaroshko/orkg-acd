...
def do_generate_datasets(
    ...
    if strategy == "citation-desc":
        ...
        dsf.partial_factory_time_bidir(
            clear_txt_dir,
            out_dataset_dir,
            increment_size=increment_size,
            metadata=metadatafile,
