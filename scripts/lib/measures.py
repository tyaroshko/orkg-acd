...
def js_divergence(v1, v2):
    ...
    for i in range(0, len(v1)):
        s = s + (v1[i] + 0.000000000001) * numpy.log(
            (v1[i] + 0.000001) / (v0[i] + 0.000001)
        )
        # abs(v1[i]-v2[i])
    for i in range(0, len(v1)):
        s = s + (v2[i] + 0.000000000001) * numpy.log(
            (v2[i] + 0.000001) / (v0[i] + 0.000001)
        )
    return s * 0.5
...
def s2jsd_divergence(v1, v2):
    s = 0
    for i in range(0, len(v1)):
        s = s + (v1[i] + 0.000001) * numpy.log(
            2 * (v1[i] + 0.000001) / (v1[i] + v2[i] + 0.000002)
        )

    for i in range(0, len(v1)):
        s = s + (v2[i] + 0.000001) * numpy.log(
            2 * (v2[i] + 0.000001) / (v1[i] + v2[i] + 0.000002)
        )
    return numpy.sqrt(s)
